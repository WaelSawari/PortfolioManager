...
async function main() {
  ...
  const companies = [
    {
      ...
      ownershipPct: 1.03,
      currentValuation: 133462.61 / 0.0103, // implied from FV and ownership
    },
    {
      name: "Almentor",
      sector: "EdTech",
  ...
  for (const round of rounds) {
    ...
    await prisma.fundingRound.create({
      data: {
        ...
        ourInvestment: round.ourInvestment,
  ...
  // ─── KPIs (Dec 31, 2025 snapshot) ────────────────────────────────────────

  const kpis = [
    { company: "SWVL", arr: null, mrr: null, burnRate: null, cashBalance: null, runway: null, headcount: null, customers: null, notes: "NASDAQ listed. Share price $1.90, 70,243 shares owned. FV: $133,462. IRR: -36.98%, MOIC: 0.047x" },
    { company: "Almentor", arr: null, mrr: null, burnRate: null, cashBalance: null, runway: null, headcount: null, customers: null, notes: "FV: $5,934,000. Company valued at $60M. IRR: 22.40%, MOIC: 2.724x" },
    { company: "MoneyFellows", arr: null, mrr: null, burnRate: null, cashBalance: null, runway: null, headcount: null, customers: null, notes: "FV: $11,232,000. IRR: 25.61% (diluted), MOIC: 2.922x. BII co-investor (1.43%)" },
    { company: "SiWare / Neospectra", arr: null, mrr: null, burnRate: null, cashBalance: null, runway: null, headcount: null, customers: null, notes: "FV: $13,061,000. IRR: 24.27%, MOIC: 2.673x" },
    { company: "Flat6Labs Cairo", arr: null, mrr: null, burnRate: null, cashBalance: null, runway: null, headcount: null, customers: null, notes: "USD NAV: $14,421,196. EGP NAV: 687,553,613. FV: $3,129,399. IRR: 4.93%, MOIC: 1.223x. Ownership: 21.7%" },
    { company: "Flat6Labs Tunis (Anava)", arr: null, mrr: null, burnRate: null, cashBalance: null, runway: null, headcount: null, customers: null, notes: "Portfolio FV TND 24.79M. FV USD: $1,447,723. IRR: -0.49%, MOIC: 0.979x. TVPI: 0.948x" },
    { company: "Pearl Semiconductors", arr: null, mrr: null, burnRate: null, cashBalance: null, runway: null, headcount: null, customers: null, notes: "FV: $3,388,000. IRR: 34.88%, MOIC: 3.791x" },
    { company: "Axis", arr: null, mrr: null, burnRate: null, cashBalance: null, runway: null, headcount: null, customers: null, notes: "FV: $4,240,041. IRR: 35.89%, MOIC: 3.608x. Diluted post-EBRD round. Ownership: 4.24%" },
    { company: "Kashier", arr: null, mrr: null, burnRate: null, cashBalance: null, runway: null, headcount: null, customers: null, notes: "FV: $2,387,807. IRR: 9.28%, MOIC: 1.365x. Ownership: 6.13%" },
    { company: "Fulfillment Bridge", arr: null, mrr: null, burnRate: null, cashBalance: null, runway: null, headcount: null, customers: null, notes: "FV: $1,500,000 (at cost). Ownership: 10.7%" },
    { company: "Blnk", arr: null, mrr: null, burnRate: null, cashBalance: null, runway: null, headcount: null, customers: null, notes: "FV: $2,590,000. IRR: 12.44%, MOIC: 1.569x. Apr-2025 round accounted for." },
    { company: "Proteinea", arr: null, mrr: null, burnRate: null, cashBalance: null, runway: null, headcount: null, customers: null, notes: "FV: $1,693,231. IRR: 73.04%, MOIC: 7.692x. Strong performer." },
    { company: "GoodsMart", arr: null, mrr: null, burnRate: null, cashBalance: null, runway: null, headcount: null, customers: null, notes: "FV at cost: $4,432,998. MOIC: 1.0x. Ownership: 33.54%" },
    { company: "Expandcart", arr: null, mrr: null, burnRate: null, cashBalance: null, runway: null, headcount: null, customers: null, notes: "FV at cost: $1,319,761. MOIC: 1.0x" },
    { company: "Docspert", arr: null, mrr: null, burnRate: null, cashBalance: null, runway: null, headcount: null, customers: null, notes: "FV at cost: $257,924. MOIC: 1.0x" },
  ];

  for (const kpi of kpis) {
    const companyId = createdCompanies[kpi.company];
    if (!companyId) { console.warn(`⚠️  Company not found for KPI: ${kpi.company}`); continue; }
  ...
  for (const s of scenarios) {
    ...
    if (!companyId) { console.warn(`⚠️  Company not found for scenario: ${s.company}`); continue; }
    await prisma.scenario.create({
      data: {
        ...
        exitValuation: s.exitValuation,
        ourOwnershipAtExit: s.ourOwnershipAtExit,
        proceeds: s.proceeds,
        irr: s.irr,
        moic: s.moic,
        notes: s.notes || null,
